...
<form id="userForm">
	...
	<input type="hidden" id="userType" name="userType" value="${loginUser.userType}" />
	<header>사용자 정보 변경</header>
	<table summary="">
		<caption></caption>
		<colgroup>
			<col width="160">
		...
		<tbody>
			<tr>
				...
				<td><input type="text" title="이름" id="userName" name="userName" class="inputTxt" value="${loginUser.userName }" /></td>
			</tr>
<!-- 			<tr> -->
...
<!-- 			</tr> -->
	...
	<div class="infoContainer">
		<p style="font-size:13px;color:#ff0000;">변경 후 자동 로그아웃 됩니다. 다시 로그인 해주세요.</p>
<!-- 		<ul> -->

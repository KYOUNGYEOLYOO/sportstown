...
<%-- 	<c:if test="${streamMeta.metaClass == 'Proxy'}"> --%>
	<c:if test="${streamMeta.metaClass == 'HD'}">
...
<c:if test="${enablePlayer == true}">
	...
	var liveStreamUrl = "${ipFilter.filterAddress(loginUser.connectLocation, liveStreamer)}/${proxyMeta.application.name}/${proxyMeta.streamName}";
	...
	flowplayer($player, {
		...
		key : "$156463494303884" // set license 192.168.240.40 
		// key : "$512206430871778" // set license localhost 

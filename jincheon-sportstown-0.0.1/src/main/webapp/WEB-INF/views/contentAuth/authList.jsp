...
$(document).ready(function(){
	...
	$("#${listId}").jqGrid({
		...
		rowList: [20,50,100],
	   	...
	   	colNames:["컨텐츠명", "사용자명", "상태", "contentId", "userId", "contentAuthId"],
	   	colModel:[
	   		{name:"content.title",index:"title", width:180,align:"left"},
	   		{name:"user.userName",index:"userName", width:180, align:"left"},
	   		{name:"state",index:"state", width:180, align:"left"},
	   		
	   		{name:"contentId", index:"contentId", hidden:true},
	   		{name:"userId", index:"userId", hidden:true},
	   		{name:"contentAuthId", index:"contentAuthId", hidden:true}
	   	],
// 	   	pager: $("#${pagerId}"),
		loadComplete : function(data){  
	   	...
	   	onSelectRow : function(id, status){
	   		var contentAuth = $(this).getRowData(id);
	   		eventSender.send("data-event-selectedRow", contentAuth);
	   	}
	});
});

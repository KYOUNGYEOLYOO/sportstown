package com.bluecapsystem.cms.jincheon.sportstown.views.job;
...
public class JobViewController {
	...
	private static final Logger logger = LoggerFactory.getLogger(JobViewController.class);
	...
	public ModelAndView index(HttpServletRequest request) {
		...
		ModelAndView mnv = new ModelAndView("/job/index");
